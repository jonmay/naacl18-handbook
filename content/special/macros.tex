...
\item \footnotesize{#1 #2}\index{#2, #1}
}

\newcommand{\sessionchair}[2]{
  \emph{Chair: #1 #2}\par\index{#2, #1}}

\newcommand{\sessionchairs}[4]{
  \emph{Chairs: #1 #2 and #3 #4}\par\index{#2, #1} \index{#4, #3}}

\newcommand{\threesessionchairs}[6]{
  \emph{Chairs: #1 #2, #3 #4 and #5 #6}\par\index{#2, #1} \index{#4, #3} \index{#6, #5}}
...
\newenvironment{OneSessionOverview}[4]{
  \section[#1]{#1 Overview -- #2}
  \setheaders{#1}{#2}
  \begin{center}
    \righthyphenmin2
    \sloppy
    \begin{tabular}{|>{\RaggedRight}p{4.0in}|}
      \hline
      \it #3 \\
      \ifthenelse{\equal{#4}{}}{\PlenaryLoc}{#4} \\
      \hline\hline}
...
\newenvironment{FourSessionOverview}[6]{
  ...
  \begin{center}
    \righthyphenmin2
    \sloppy
    \begin{tabular}{>{\RaggedRight}p{1in}|>{\RaggedRight}p{1in}|>{\RaggedRight}p{1in}|>{\RaggedRight}p{1in}}
      %\hline
      \bf Track A & \bf Track B & \bf Track C & \bf Track D \\%\hline
      \it #3 & \it #4 & \it #5 & \it #6\\
...
\newenvironment{FourSessionExceptionOverview}[6]{
  \section[#1]{#1 Overview -- #2}
  \setheaders{#1}{#2}
  \begin{center}
    \righthyphenmin2
    ...
    \begin{tabular}{>{\RaggedRight}p{1in}|>{\RaggedRight}p{1in}|>{\RaggedRight}p{1in}|>{\RaggedRight}p{1in}}
      %\hline
      \bf Track A & \bf Track B & \bf Track C & \bf Track P \\%\hline
      \it #3 & \it #4 & \it #5 & \it #6\\
      \TrackALoc & \TrackBLoc & \TrackCLoc & \TrackPLoc \\%\\
      \hline\hline}
      {\end{tabular}\end{center}}
  %{\hline\end{tabular}\end{center}}
