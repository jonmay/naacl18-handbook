...
%\noindent
%\includepdf{content/fmatter/cc.png}\includepdf{{content/fmatter/cc.large}}
%\raisebox{-\mydepth{\includepdfmerge[nup=3x1,width=.2in]{content/fmatter/cc.png, content/fmatter/by.png, content/fmatter/nc.png}}}
\noindent
