...
\begin{SingleTrackSchedule}
  ...
  \begin{tabular}{|p{0.6in}|p{0.6in}|p{0.6in}|p{0.7in}|p{0.7in}|} \hline
    \multicolumn{3}{|l|}{{\bfseries Research Oral 1/2}} & {\bfseries Industrial Oral 1/2} & {\bfseries Poster/Demo  (10:30-12:00)}\\\hline
    Information Extraction 1 & Phonology, Morphology and Word Segmentation 1 & Speech 1 & Industrial: Machine Learning -- Classification & \footnotesize{NLP Applications 1 / Discourse and Pragmatics 1 / Generation 1 / Demos}\\
...
Machine Learning 1 & Information Extraction 2 & Machine Translation 1 & Industrial: Dialog & \\
...
\emph{Empire A} & \emph{Empire B } & \emph{Empire C } & \emph{Elite Hall B} \\
  ...
  \begin{tabular}{|p{0.8in}|p{0.8in}|p{0.8in}|p{0.85in}|}
    \multicolumn{3}{|l|}{{\bfseries Research Oral 4}} & {\bfseries Industrial Oral 4}\\ \hline
