...
\begin{SingleTrackSchedule}
  ...
  \begin{tabular}{|p{0.6in}|p{0.6in}|p{0.6in}|p{0.7in}|p{0.7in}|} \hline
    ...
    Information Extraction 1 & Phonology Morphology and Word Segmentation & Speech & Machine Learning -- Classification & NLP Applications / Discourse and Pragmatics / Generation / Demos\\
...
\emph{Empire A } & \emph{Empire B } & \emph{Empire C } & \emph{Empire D } & \emph{Elite Hall B}\\
 ...
 Machine Learning 2 & Social Media and Computational Social Science 1 & Vision, Robotics and Other Grounding 1 & Semantics / Sentiment Analysis / Demos \\
